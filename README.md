...
a persistence unit "appPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "app\pom.xml":
...
artifact ("app.war") is already built. You can build
